    ...
    gitlabCi(validate = true, "../.gitlab-ci.yml") {
        ...
        job("helm-publish-release-candidate") {
            ...
            script(
                ...
                "curl -fsv --request POST --user \$JFROG_USERNAME:\$JFROG_API_KEY --form \"chart=@genre-police-\$CHART_VERSION.tgz\" https://rbbl.jfrog.io/artifactory/gp-helm/\$CHART_VERSION.tgz"
            )
            rules {
                rule {
